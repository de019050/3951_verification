...
author: "Package: SO3951Verification"
date: "`r Sys.Date()`"
...
This vignette explains how to use the two main functions provided by the `SO3951Verification` package:
...
The `SO3951Verification` package offers a simple but powerful interface to perform lot verification based on ISO 3951-2, with:
